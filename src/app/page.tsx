...
export default function Home(){
  ...
  const steps=[{l:"Text it",d:"Tell Outdoors what you need. Plain English. That\u2019s it."},{l:"It takes over",d:"Opens your laptop, logs into your real apps."},{l:"It does the work",d:"Writes the email, books the meeting, updates the doc."},{l:"Done",d:"Actually completed. Not suggested. Not drafted. Done."}];
  const caps=[
    {icon:"\u2709\uFE0F",t:"Email",d:"Say who and what. It drafts, sends, and follows up from your real Gmail. You never open your laptop."},
    {icon:"\uD83D\uDCC5",t:"Calendar",d:"Meetings booked, conflicts resolved, focus time blocked. The scheduling nightmare is over."},
    {icon:"\uD83D\uDCC4",t:"Documents",d:"Proposals, applications, briefs. Written from your real files and templates. Ready to send."},
    {icon:"\uD83D\uDCCA",t:"Spreadsheets",d:"Data pulled, reports formatted, dashboards updated. Hours of busywork gone in seconds."},
    {icon:"\uD83D\uDCAC",t:"Messaging",d:"Slack updates, Teams check-ins, status reports. All sent without you typing a word."},
    {icon:"\uD83D\uDCC1",t:"Files",d:"Drive organized, folders sorted, files shared with the right people. Instantly."},
  ];
  ...
  <section className="hero">
    ...
    <p className="hero-sub">The wealthy have always had people to handle their busywork. We{"'"}re fixing that.</p>
  ...
  <div className="hero-quotes">
    ...
    <div className="quote-card rv q0"><div className="quote-text">I connected it to my boss{"'"}s email. Now whenever he asks me to do something, Outdoors just handles it. I haven{"'"}t actually done real work in two weeks.</div><div className="quote-name">Operations Associate</div></div>
    <div className="quote-card rv q1"><div className="quote-text">I pointed it at my med school portal. Every time an assignment drops, it reads the syllabus, does the work, and submits it. I just study for boards now.</div><div className="quote-name">Med Student</div></div>
    <div className="quote-card rv q2"><div className="quote-text">It runs our outbound. 1,000+ personalized messages a day across LinkedIn, email, and Twitter. Our pipeline tripled. Nobody sends a single message manually.</div><div className="quote-name">Startup Founder</div></div>
    <div className="quote-card rv q3"><div className="quote-text">Had it apply to 100 jobs in one night. Got 14 interviews. It{"'"}s also working two of those jobs for me now. I{"'"}m literally getting paid to do nothing.</div><div className="quote-name">Recent Grad</div></div>
    <div className="quote-card rv q4"><div className="quote-text">My landlord tried to raise my rent. I had Outdoors research tenant law, draft a response citing three statutes, and send it from my email. Rent stayed the same.</div><div className="quote-name">Grad Student</div></div>
    <div className="quote-card rv q5"><div className="quote-text">I gave it my class schedule and every professor{"'"}s email. It emails them when I{"'"}m sick, requests extensions, sends thank-you notes after office hours. My profs think I{"'"}m the most organized student they{"'"}ve ever had.</div><div className="quote-name">Pre-Med Junior</div></div>
  </div>
  ...
  <section className="manifesto rv"><div className="manifesto-inner"><p>A personal assistant used to cost $60,000 a year. Now it costs a <span>text message.</span></p><p>Every hour you spend on work is an hour you{"'"}ll never get back. The people who get ahead aren{"'"}t smarter. They just <span>delegate everything.</span></p></div></section>
  ...
  <section className="pricing-section" id="pricing"><div className="pricing-inner"><div className="sec-hd rv"><div className="lbl">Pricing</div><h2>Less than your daily coffee. More than an extra pair of hands.</h2></div>
    <div className="pg">
      <div className="pc"><div className="pc-t">Free</div><div className="pc-a">$0</div><div className="pc-p">per month</div><ul className="pc-l"><li>Bring your own API key</li><li>Core assistant</li><li>Email + calendar</li><li>Community support</li></ul><a href="sms:8032920205" className="pc-b">Get Started</a></div>
      <div className="pc pop"><div className="pc-t">Pro</div><div className="pc-a">$30</div><div className="pc-p">per month</div><ul className="pc-l"><li>No API key needed</li><li>All features</li><li>Priority execution</li><li>Email support</li></ul><a href="sms:8032920205" className="pc-b">Talk to us</a></div>
      <div className="pc"><div className="pc-t">Premium</div><div className="pc-a">$100</div><div className="pc-p">per month</div><ul className="pc-l"><li>Unlimited usage</li><li>Custom integrations</li><li>Phone support</li><li>Early access</li></ul><a href="sms:8032920205" className="pc-b">Talk to us</a></div>
    </div>
  ...
  <footer><div className="fi"><span className="logo">outdoors</span><ul className="fl"><li><a href="#steps">Product</a></li><li><a href="#pricing">Pricing</a></li></ul><span className="fn">Built at Rice University</span></div></footer>
