...
const slides: Slide[] = [
  ...
  { src: "/images/20251026_022124.webp", caption: "I was researching a go to market strategy", color: "#4A5D3A", hoverColor: "#6E8A58" },
  { src: "/images/20251122_213844.webp", caption: "I was finishing my thesis", color: "#B47B56", hoverColor: "#C99A78" },
  { src: "/images/20251127_083555.webp", caption: "I was turning GitHub into a personal website", color: "#6B7F5E", hoverColor: "#8FA882" },
  { src: "/images/20251214_163214.webp", caption: "I was prepping for a case competition", color: "#9C7B5B", hoverColor: "#BDA07E" },
  { src: "/images/20251230_080722.webp", caption: "I was building an MVP for an idea", color: "#5A6B4A", hoverColor: "#7E9468" },
  { src: "/images/20260206_180352 (1).webp", caption: "I was outlining a grant proposal", color: "#A0805A", hoverColor: "#C4A57E" },
  { src: "/images/IMG-20251018-WA0062.webp", caption: "I was drafting ideas for marketing", color: "#6E8060", hoverColor: "#92A884" },
...
export default function Carousel() {
  ...
  useEffect(() => {
    ...
    baseSpeedRef.current = isMobile ? 2 : 1.5;
    ...
    const handleResize = () => {
      ...
      baseSpeedRef.current = mobile ? 2 : 1.5;
      halfWidth = measureHalf();
    };
